...
function PrayTimes(method) {
	...
	*/	
	...
	getFormattedTime: function(time, format, suffixes) {
		...
		return (hour<10 ? '0'+hour : hour) + ':'+ this.twoDigitsFormat(minutes)+ (suffix ? ' '+ suffix : '');
	},
	...
	computeTimes: function() {
		...
		// add midnight time
		times.midnight = times.sunset + (this.timeDiff(times.sunset, times.fajr)/3)*2;
...
document.getElementById("isha").innerHTML = timeObj.isha;
document.getElementById("midnight").innerHTML = timeObj.midnight;
